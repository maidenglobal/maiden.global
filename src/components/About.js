...
export default () =>
  ...
  <div className="left vspace-giant">
    <h1 className='title'>Maiden carries out its mission through three initiatives:</h1>
    <ol>
    ...
    <div className='vspace-giant'>
      ...
      <div className='paragraphs'>
        <p>Shira brings over 15 years of work in politics, social change, women’s philanthropy, and fundraising with her to the Blockchain and Fin-Tech industries. Shira spent seven years as a Deputy Director for J Street—the single-largest pro-Israel PAC in the US—working to transform the way Congress and the Executive branch engage in the Middle East and to promote the creation of a two-state solution to the Israeli-Palestinian conflict. During Shira tenure, J Street partnered with the Obama Administration to successfully push the Iran-Nuclear deal through Congress and prevent a war with Iran. Shira holds a degree in Government and Political Theory from Smith College. She hails from the Redwood Coast of Arcata, CA and after spending eight years in our nation’s capital, she recently found her heart back in the wild west where she is currently living in Boulder, CO.</p>
      </div>
    </div>
