...
const Home = () =>
  <Layout activeTab="home" label="true">
    ...
    <h2 className='vspace'>Maiden Labs is made possible by leading blockchain companies who are invested in the decentralized future. Membership is currently open.</h2>
