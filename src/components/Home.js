...
const Home = () =>
  <Layout activeTab="home">
    <h1>Maiden creates a more intelligent economy by diversifying the leaders and makers in Finance and Blockchain Technology.</h1>
    ...
    <div className="left vspace-giant">
      ...
      <ol>
        ...
        <li><b>Diversity-Powered Consulting</b>: Providing expert-level blockchain consulting, from token sale audits to smart contract development.</li>
      </ol>
    </div>
